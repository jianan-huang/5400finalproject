...
from financial_news_sentiment.models.visualize_and_evaluate import run_visualization_and_evaluation
...
def run_pipeline():
    ...
    run_visualization_and_evaluation(feature_engineered_data_path, model_output_path, 'results/visualizations/')
