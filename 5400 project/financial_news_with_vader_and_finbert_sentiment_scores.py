...
# Load the preprocessed financial news dataset with VADER sentiment labels and scores
...
def classify_with_finbert_with_score(text):
    try:
        ...
        score = result[0]['score'] if label != 'neutral' else 0.0  # Assign 0 for neutral to indicate no significant sentiment polarity
        return label, score
