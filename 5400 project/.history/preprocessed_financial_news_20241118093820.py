...
# Load each CSV file
finance_df = pd.read_csv('data/filtered_finance_financial_news.csv')
healthcare_df = pd.read_csv('data/filtered_healthcare_financial_news.csv')
tech_df = pd.read_csv('data/filtered_tech_financial_news.csv')
