...
from timeseries import generate_timeseries_plot
...
plot_confusion_matrices(results, label_encoder, VISUALIZATION_DIR)
...
generate_timeseries_plot(SENTIMENT_OUTPUT_FILE, STOCK_FILE, VISUALIZATION_DIR)
